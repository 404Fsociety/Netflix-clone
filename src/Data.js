export const moviesData = [
    {
        ...
        rate: 5,
        description:
            "9 months after barely surviving a previous mission in Dhaka, Bangladesh, Tyler Rake retires from mercenary work to a cabin in Austria to recuperate.",
        posterUrl:
            "https://www.avcesar.com/source/actualites/00/00/99/60/derniere-bande-annonce-tyler-rake-2-silence-ca-tourne-action_05113918.jpg",
        trailer:"https://www.youtube.com/embed/Lc2mwVUuGn8",
        },
        {
            id: 2,
            ...
            posterUrl:
                "https://thefilmstage.com/wp-content/uploads/2015/11/central_intelligence_poster.jpg",
            trailer:"https://www.youtube.com/embed/MxEw3elSJ8M",
            },
            {
                id: 3,
                title: "The man from Torento",
                rate: 3,
                description:
                    "L'assassin le plus meurtrier du monde et le plus gros raté de New York sont pris l'un pour l'autre lors d'une location Airbnb.",
                posterUrl:
                    "https://m.media-amazon.com/images/M/MV5BZDM2YjA2ZjAtMmZmMy00NDhjLWJjYWYtYjc4ZGY0YzUzOTMyXkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_.jpg",
                trailer:"https://www.youtube.com/embed/urqy8DrcGBs",
                },
    {
        id: 4,
